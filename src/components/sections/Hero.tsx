  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="container-tight section-padding relative z-10 flex flex-col items-center justify-between min-h-[80vh]">
        ...
        >
          {/* Headline */}
          <h1 id="hero-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-tight mb-6 leading-[0.95] flex flex-col items-center">
            <span className="text-foreground/90 whitespace-nowrap">Websites that turn interest into</span>
            <span className="text-gradient font-black whitespace-nowrap">booked calls automatically</span>
          </h1>
