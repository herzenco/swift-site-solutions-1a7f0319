...
export const ChatWidget = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hi! I'm here to help you learn about our custom website services. What would you like to know?",
    },
  ]);
  ...
  const extractAndSaveLead = async (content: string) => {
    ...
    if (leadMatch) {
      ...
      // Return content without the marker
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Process lead capture and clean up message
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-card">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-sm">Xyren Assistant</h3>
