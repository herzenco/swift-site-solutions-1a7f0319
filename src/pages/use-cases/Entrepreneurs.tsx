...
const features = [
  {
    ...
    description: "Let AI handle customer inquiries, scheduling, and follow-ups while you focus on growth.",
  },
  {
    icon: Rocket,
    title: "Launch-Ready in Days",
    description: "Go from idea to live website in 5-10 days, not months. Start generating leads immediately.",
  },
  {
    icon: Globe,
    title: "Professional Presence",
    description: "Look like an enterprise from day one with a polished, conversion-optimized website.",
  },
];

const benefits = [
  "Compete with larger companies on day one",
  "Automate tasks you'd normally hire for",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-20">
        <div className="container-tight px-6">
          ...
          >
            <h2 className="text-3xl font-bold mb-8 text-center">Why Entrepreneurs Choose Us</h2>
          ...
          >
            <h2 className="text-3xl font-bold mb-4">Ready to Build Your Digital Employee?</h2>
            <p className="text-muted-foreground mb-8">Get a website that works around the clock for your business.</p>
            <Button 
              className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-lg font-semibold rounded-xl"
